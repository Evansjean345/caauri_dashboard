...
function Navbar() {
  ...
  return (
    <div className="flex flex-no-wrap">
      ...
      <div className="w-64 absolute sm:relative bg-black shadow h-[300vh] flex-col justify-between hidden sm:flex">
          ...
          <form className="flex flex-col w-full" onSubmit={handleSubmit}>
            <div className="flex">
              <div className="w-1/2 py-8 px-8">
                ...
                <Textarea
                  variant="standard"
                  label="Sous-titres page d'acceuil"
                  value={subtitle}
                ...
                <Textarea
                  ...
                  onChange={(e) => {
                    ...
                    setSection((prevRecipient) => ({
                      ...prevRecipient,
                      p1: value,
                    }));
                  }}
                />
                <strong>Web & Dévéloppement</strong>
                <Textarea
                  variant="standard"
                  label="Web & Dévéloppement"
                  value={section.p2}
                  onChange={(e) => {
                    const value = e.target.value;
                    setSection((prevRecipient) => ({
              ...
              <div className="w-1/2 py-8 px-8">
                ...
                />
                <strong>Agence digitale</strong>
                <Textarea
                  variant="standard"
                  label="Agence digitale p1"
                  value={pub.p1}
                  onChange={(e) => {
                    const value = e.target.value;
                    setPub((prevRecipient) => ({
                      ...prevRecipient,
                      p1: value,
                    }));
                  }}
