...
function Career() {
  ...
  return (
    <div className="flex flex-no-wrap">
      ...
      <div className="w-64 absolute sm:relative bg-black shadow h-[400vh] flex-col justify-between hidden sm:flex">
      ...
      <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
          ...
          <form className="flex flex-col w-full" onSubmit={handleSubmit}>
            <div className="flex">
              <div className="w-1/2 py-8 px-8">
                ...
                />
                <strong>Description du post</strong>
                <Textarea
                  variant="standard"
              ...
              <div className="w-1/2 py-8 px-8">
                <strong>Lien pour postuler</strong>
                <Textarea
                  variant="standard"
        ...
        <div className="w-full flex flex-wrap  mb-12 p-8 rounded shadow-xl">
          {allData.map((data, index) => (
            <div
              key={data._id}
              className="xl:w-1/4 rounded-xl shadow-2xl p-4 m-8"
            >
              <form
              ...
              >
                ...
                <Textarea
                  ...
                  label="lien pour postuler"
                  value={data.go_to}
                  onChange={(e) => handleChange(index, "go_to", e.target.value)}
                />
        ...
        <div className="w-full h-[100vh] rounded border-dashed border-2 border-gray-300">
          <iframe
            src="https://caauri.netlify.app/carriere"
