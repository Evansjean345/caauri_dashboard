    ...
    <div className="flex flex-no-wrap">
      ...
      <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
          ...
          <form className="flex flex-col w-full" onSubmit={handleSubmit}>
            <div className="flex">
              <div className="w-1/2 py-8 px-8">
                <strong>Agence de publicité digitale</strong>
                <Textarea
                  variant="standard"
                  label="paragraphe 1"
                  value={firstSection.p1}
                  onChange={(e) => {
              ...
              <div className="w-1/2 py-8 px-8">
                ...
                />
                <strong>Titre du bas(Paragraphe)</strong>
                <Textarea
                  variant="standard"
                  label="paragraphe"
                  value={lastSection.p}
        ...
        <div className="w-full h-[100vh] rounded border-dashed border-2 border-gray-300">
          <iframe
            src="https://caauri.netlify.app/caaurimuniquez"
