...
function Blog() {
  ...
  const [allData, setAllData] = useState([
    { title: "", subtitle: "", content: "", cover: null },
  ]);
    ...
    <div className="flex flex-no-wrap">
      ...
      <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
          ...
          <form className="flex flex-col w-full" onSubmit={handleSubmit}>
            <div className="flex">
              ...
              <div className="w-1/2 py-8 px-8">
                ...
                />
                {render && (
                  <div className="h-96 w-96 mt-6">
                    <img
                      src={render}
                      alt=""
                      className="h-full max-w-full ml-auto mr-auto"
                    />
                  </div>
                )}
              </div>
          ...
          {allData.map((data, index) => (
            ...
            >
              ...
              >
                ...
                <img
                  src={data.cover}
                  className="h-32 ml-auto mr-auto w-full px-12 "
                />
        ...
        <div className="w-full h-[100vh] rounded border-dashed border-2 border-gray-300">
          <iframe
            src="https://caauri.netlify.app/blog"
