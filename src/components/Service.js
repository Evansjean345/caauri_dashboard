    ...
    <div className="flex flex-no-wrap">
      ...
      <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
          ...
          <form className="flex flex-col w-full" onSubmit={handleSubmit}>
            <div className="flex">
              <div className="w-1/2 py-8 px-8">
                ...
                />
                <strong>Web & développemnt</strong>
                <Textarea
                  variant="standard"
                  label="Web & développemnt"
                  value={web.pp}
                  onChange={(e) => {
                    const value = e.target.value;
                    setWeb((prevRecipient) => ({
                      ...prevRecipient,
                      pp: value,
                    }));
                  }}
              ...
              <div className="w-1/2 py-8 px-8">
                ...
                />
                <strong>Agence Formation</strong>
                <Textarea
                  variant="standard"
                  label="pargraphe 1"
                  value={formation.p1}
        ...
        <div className="w-full h-[100vh] rounded border-dashed border-2 border-gray-300">
          <iframe
            src="https://caauri.netlify.app/services"
